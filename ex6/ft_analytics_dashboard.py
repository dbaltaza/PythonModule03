if __name__ == "__main__":
    scores = {
        'alice': 2300, 'bob': 1800,
        'charlie': 2150, 'diana': 3000,
        'john': 750, 'gregory': 1200
    }
    ...
    players_regions = {
        'alice': 'north', 'bob': 'east',
        'diana': 'south', 'charlie': 'central',
        'john': 'north', 'gregory': 'south'
    }
    regions = {players_regions[p] for p in activeplayers}
    alice_achievements = {
        "high_scorer", "mid_scorer",
        "low_scorer", "first_kill",
        "boss_slayer"
    }
    bob_achievements = {
        "mid_scorer", "low_scorer",
        "first_kill"
    }
    john_achievements = {
        "low_scorer"
    ...
    print(f"Top performer: {max_scores} ({scores[max_scores]} points, "
